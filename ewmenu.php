...
$RootMenu->AddMenuItem(4, "mi_t9903_userlevelpermissions", $Language->MenuPhrase("4", "MenuText"), "t9903_userlevelpermissionslist.php", 3, "", (@$_SESSION[EW_SESSION_USER_LEVEL] & EW_ALLOW_ADMIN) == EW_ALLOW_ADMIN, FALSE, FALSE);
