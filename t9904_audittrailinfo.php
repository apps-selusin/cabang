...
class ct9904_audittrail extends cTable {
	...
	function __construct() {
		...
		// table
		$this->table = new cField('t9904_audittrail', 't9904_audittrail', 'x_table', 'table', '`table`', '`table`', 200, -1, FALSE, '`table`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->table->Sortable = TRUE; // Allow sort
		$this->fields['table'] = &$this->table;

		// field
		$this->field = new cField('t9904_audittrail', 't9904_audittrail', 'x_field', 'field', '`field`', '`field`', 200, -1, FALSE, '`field`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
