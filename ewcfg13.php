...
define("EW_RANDOM_KEY", 'I27bb245I5GHVWsa', TRUE); // Random key for encryption
...
$EW_CONN["DB"] = array("conn" => NULL, "id" => "DB", "type" => "MYSQL", "host" => "localhost", "port" => 3307, "user" => "root", "pass" => "admin", "db" => "db_cabang", "qs" => "`", "qe" => "`");
